(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/Level3.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'b1226OKFhtKz5I8ZNdITgmg', 'Level3', __filename);
// Script/Level3.js
    ...
    throwKnife: function throwKnife() {
        ...
        if (this.isThrow) {
            ...
            this.knifeNode.runAction(cc.sequence(cc.moveTo(0.1, cc.v2(this.knifeNode.x, this.boardNode.y - this.boardNode.width / 2)), cc.callFunc(function () {
                cc.audioEngine.play(_this2.knifeFail, false, 1);
                var isHit = false;
